    ...
    return (
      <div className="mx-auto max-w-2xl px-4 pt-32 pb-12 sm:px-6 sm:pt-28">
        <div className="card grid place-items-center gap-3 rounded-lg p-12 text-center">
          ...
          <h1 className="text-lg font-black text-ink">Responder perguntas</h1>
          <p className="max-w-sm text-sm text-ink-soft">
            Entre com uma conta de vendedor para responder às perguntas dos
            clientes sobre os produtos da sua loja.
          </p>
          <Link
            to="/entrar"
